...
class SelectFirstFrames_two(object):
    def __init__(self, number_of_frames=24):
        self.number_of_frames = number_of_frames

    def __call__(self, clip):
        """
        Args:
        clip (numpy.ndarray): numpy array of shape (num_frames, 10, 2)
        Returns:
        numpy.ndarray: Array of shape (self.number_of_frames, 10, 2) containing first self.number_of_frames of clip
        """
        selected = clip[:self.number_of_frames]
        return selected    
